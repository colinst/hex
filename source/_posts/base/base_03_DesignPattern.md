...
当  
创建复杂对象的算法  
    应该独立于该对象的组成部分及它们装配方式时  
    适用的模式


# 观察者模式 | Publish/Subscribe
观察者模式帝国一了一种一对多的依赖关系，让多个观察者同时监听某一个主题对象。
这个主题对象在状态发生变化时，会通知所有观察者对象,使它们能够自动更新自己。  
![观察者模式](base_03_DesignPattern/观察者模式.png)  
具体的场景：老板回来了，前台通知同事别玩了  
![老板回来了](base_03_DesignPattern/具体场景-老板回来了.png)
